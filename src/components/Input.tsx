    ...
    return (
      <label className="relative">
        ...
        <input
          type={type}
          className={cn(
            "border-input ring-offset-background file:text-foreground placeholder:text-muted-foreground flex h-[44px] w-full rounded-md border-[2px] border-[#79747E] bg-alpha-bg px-3 py-2 text-[1.6rem] outline-none file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:cursor-not-allowed disabled:opacity-50",
            className,
          )}
          ref={ref}
          {...props}

...
export const HoverTag: React.FC<Partial<Props>> = ({
  ...
  return (
    <div
      onClick={onClick}
      className="flex cursor-pointer items-center rounded-[4px] px-[10px] py-[12px] text-[#818086] transition-colors duration-75 hover:bg-alpha-bg hover:text-text-item-hover group-hover:bg-alpha-bg group-hover:text-text-item-hover"
    >

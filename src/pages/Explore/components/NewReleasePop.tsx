  ...
  return (
    <div className="w-[280px] p-[15px]">
      <div className="flex gap-[10px]">
        ...
        <div>
          <h3 className="new-release-pop-title cursor-pointer text-[1.4rem] font-[500] hover:text-text-item-hover">
      ...
      <div className="mb-[10px] mt-[15px] flex h-[50px] rounded-[8px] bg-[rgba(0,0,0,0.05)]">
        <div className="flex flex-1 cursor-pointer flex-col items-center justify-center gap-2 rounded-[8px] py-[8px] hover:bg-[rgba(0,0,0,0.05)] hover:text-text-item-hover">
      ...
      <div>
        <PopHoverTag
          ...
          LeftIcon={() =>
            data?.data.data.isLiked ? (
              <HeartIconSolid className="text-purple-primary" />
            ) : (
              <HeartIcon />
            )
          }
      ...
      <p className="mt-[6px] text-center text-[1.3rem] font-[500] text-text-secondary">
